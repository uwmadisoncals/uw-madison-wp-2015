...
<?php while( have_rows('custom_groups') ): the_row(); ?>
    ...
    $( document ).ready(function() {
                    ...
                    $(".periodic_overlay, .periodic_frame .close").click(function(e) {
                        ...
                        $(".periodic_overlay, .periodic_frame").removeClass("shown");
                        $(".periodic_frame .video_Wrapper").html("");
                    });
        ...
        <?php while( have_rows('interactive_elements') ): the_row(); 
           ...
           <script>
               ...
               $( document ).ready(function() {
                   ...
                   var selector = "<?php echo $element ?>";
                   var clickselector = ".<?php echo $element ?>";
                   ...
                   $(clickselector).replaceWith(newinnerhtml);


                   if(action == "url") {
                    $(clickselector).attr("href", url);
                   } else {
