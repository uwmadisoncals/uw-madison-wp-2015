...
gulp.task('scripts', function() {
  return gulp.src(['bower_components/jquery/dist/jquery.min.js','js/jquery.suggest.js','js/owlcarousel/owl.carousel.min.js','js/detectbrowser.js','js/fastclic.js','js/global.js'])
    .pipe(concat('main.js'))
