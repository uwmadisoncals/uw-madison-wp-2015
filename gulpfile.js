...
gulp.task('scripts', function() {
  return gulp.src(['js/jquery.visible.js','js/jquery.suggest.js','js/color-thief.min.js','js/color-thief-init.js','js/flickity.js','js/isotope.min.js','js/imagesloaded.js','js/detectbrowser.js','js/fastclick.js','js/global.js'])
    .pipe(concat('main.js'))
